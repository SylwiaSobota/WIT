    ...
    <form method="post" action="">
        <table>
			...
			<tr>
				...
				<td><input type="radio" name="abs" id="abs" value="tak"<?= ($wiersz['abs'] ?? '') == 'tak' ? 'checked' : '' ?>>tak</td>
				<td><input type="radio" name="abs" id="abs" value="nie"<?= ($wiersz['abs'] ?? '') == 'nie' ? 'checked' : '' ?>>nie</td>
			</tr>
			<tr>
				<td>ESP</td>
